...
export default function LoginPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Dummy login logic
    if (email === "reginaaruan@gmail.com" && password === "REGINA777") {
      router.push("/");
    } else if (email === "adminheallink@gmail.com" && password === "REGINA777") {
      router.push("/");
    } else if (email === "companyheallink123@example.com" && password === "REGINA777") {
      router.push("/");
    } else {
